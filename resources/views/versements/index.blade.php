...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <div class="py-3 mb-4">
        ...
        <a class="btn btn-outline-primary" href="{{ route('versements.create') }}">Ajouter</a>
      </div>
      <!-- Hoverable Table rows -->
      <div class="card">
        <h5 class="card-header">Liste des versements</h5>
        ...
        <div class="table-responsive text-nowrap">
          <table class="table table-hover">
            ...
            <tbody class="table-border-bottom-0">
              ...
              <tr>
                <td>{{ $versement->id }}</td>
                <td>{{ $versement->auditeur->nom }} {{ $versement->auditeur->prenom }}</td>
