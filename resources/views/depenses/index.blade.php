...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <div class="py-3 mb-4">
        <h4 class="fw-bold"><span class="text-muted fw-light">TABLEAU DES DEPENSES</h4>
        <a class="btn btn-outline-primary" href="{{ route('depenses.create') }}">Ajouter</a>
      </div>
      ...
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          ...
          <form action="{{ route('depenses.index') }}" method="GET" class="mb-3">
        ...
        @if($depenses->isEmpty())
          <p class="card-header">Aucune Depense pour l'instant. <br> Cliquez sur le bouton <b>AJOUTER</b> pour ajouter une formation</p>
        @else
