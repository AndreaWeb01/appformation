...
<html lang="fr" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="../assets/" data-template="vertical-menu-template-free">
  <head>
    ...
    <title>S'enregistrer | AppSAGERH</title>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">SagesRHApp</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to AppSAGESRH! 👋</h4>
              <p class="mb-4">Enregistrez un compte</p>
              ...
              <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control" id="name" :value="old('name')"  placeholder="Entrez votre nom" required autofocus autocomplete="name"/>
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="email" name="email" placeholder="Entrez votre email" :value="old('email')" required autocomplete="username" />
                    @error('email')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
